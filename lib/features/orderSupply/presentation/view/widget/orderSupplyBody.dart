...
import 'package:inventory/features/orderSupply/presentation/view/widget/LastOrderSupplyView.dart';
...
Future<bool> checkPendingOrders(String branchId) async {
  try {
    final url = Uri.parse(Apiendpoints.baseUrl + Apiendpoints.orderSupply.getAll);
...
var canedit;
OrderSupplyBody({required this.canedit});
  @override
...
product.quantity = newValue.toDouble();
  ...
  Widget _buildCurrentScreen() {
    switch (_currentIndex) {
      ...
      case 1:
        return LastOrderSupplyview(role: "user", canedite: widget.canedit);
      default:
        return _buildOrderSupplyScreen();
    }
  }
