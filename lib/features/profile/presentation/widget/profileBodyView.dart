...
import 'package:inventory/features/profile/presentation/widget/languageDropdown.dart';
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: CircleAvatar(
                  radius: 65,
                  backgroundColor: const Color(0xFFCDBCA2).withOpacity(0.3), // Updated circle background
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: userData['role'] == 'user'.tr()
                      ? const Color(0xFF74826A).withOpacity(0.15) // Updated color
                      : const Color(0xFFEDBE2C).withOpacity(0.15), // Updated color
                  borderRadius: BorderRadius.circular(20),
                  border: Border.all(
                    color: userData['role'] == 'user'.tr()
                        ? const Color(0xFF74826A).withOpacity(0.3) // Updated color
                        : const Color(0xFFEDBE2C).withOpacity(0.3), // Updated color
                    width: 1,
                  ),
                ),
                child: Text(
              ...
              Row(
                children: [
                  Padding(
                    ...
                    child: Text("اللغة :".tr() ,style: GoogleFonts.cairo(fontSize: 16),),
                  ),
                  Spacer(),
                                              Padding(
                                                padding: const EdgeInsets.all(8.0),
    ...
    return Card(
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              _buildInfoRow(Icons.phone_iphone_outlined, 'رقم الهاتف'.tr(),
                  userData['phone'] ?? 'لم يتم توفيره'.tr(), const Color(0xFF74826A)), // Updated color
              const Divider(height: 24, thickness: 0.8),
              _buildInfoRow(
                  Icons.verified_user_outlined,
                  'حالة الحساب'.tr(),
                  userData['isVerified'] ? 'مفعل'.tr() : 'غير مفعل'.tr(),
                  userData['isVerified'] ? const Color(0xFF74826A) : const Color(0xFFEDBE2C)), // Updated colors
              const Divider(height: 24, thickness: 0.8),
              _buildInfoRow(Icons.calendar_today_outlined, 'تاريخ إنشاء الحساب'.tr(),
                  _formatDate(userData['createdAt']), const Color(0xFFCDBCA2)), // Updated color
              const Divider(height: 24, thickness: 0.8),
              _buildInfoRow(Icons.update_outlined, 'آخر تحديث'.tr(),
                  _formatDate(userData['updatedAt']), const Color(0xFF74826A)), // Updated color
            SizedBox(height: 10,),
            ],
          ),
        ),
          ...
          Column(
            children: departments.map<Widget>((dept) {
              return Padding(
                ...
                child: Row(
                  children: [
                    Icon(Icons.apartment_outlined, size: 20, color: const Color(0xFF74826A)), // Updated color
