...
import 'package:inventory/features/orderProduction/presentation/view/widget/LastOrderProductionView.dart';
...
Future<void> createOrderProduction({
  ...
  try {
    ...
    final response = await http.post(
      ...
      body: jsonEncode({
        ...
        'package': package.isEmpty ? "" : package,
        'qty': qty,
        "ordername": ordername,
...
Future<bool> checkPendingOrders(String branchId) async {
  try {
    final url = Uri.parse(Apiendpoints.baseUrl + Apiendpoints.orderProduction.getAll);
...
class OrderProductionBody extends StatefulWidget {
var canedit;
OrderProductionBody({required this.canedit});
  @override
  _OrderProductionScreenState createState() => _OrderProductionScreenState();
}

class _OrderProductionScreenState extends State<OrderProductionBody> {
  ...
  Future<void> _fetchBranches() async {
    try {
      ...
      final userBranchesResponse = await http
          .get(Uri.parse(Apiendpoints.baseUrl + 'auth/user/BranchOP'),headers: {
        ...
        products = branch.products
            ...
            .map((p) {
              ...
              return Product(
                ...
                isorderProduction: p.isorderProduction, 
...
product.quantity = newValue.toDouble();
          ...
          bottomNavigationBar: BottomNavigationBar(
            ...
            items: [
              BottomNavigationBarItem(
                icon: Icon(Icons.production_quantity_limits, size: iconSize),
                label: 'طلب إنتاج'.tr(),
              ),
              BottomNavigationBarItem(
  ...
  Widget _buildCurrentScreen() {
    switch (_currentIndex) {
      case 0:
        return _buildOrderProductionScreen();
      case 1:
        return Lastorderproductionview(role: "user", canedite: widget.canedit,);
      default:
        return _buildOrderProductionScreen();
    }
  }
  ...
  Future<void> _submitOrder() async {
    ...
    try {
      ...
      var orderNameM = 'طلب انتاج - ${now.day}/${now.month}/${now.year} - ${now.hour}:${now.minute}';
...
class Product {
  ...
  Product({
    ...
    required this.isorderProduction,
    this.quantity = 0,
  });
  ...
  factory Product.fromJson(Map<String, dynamic> json) {
    return Product(
      ...
      isorderProduction: json['isorderProduction'] ?? false,
